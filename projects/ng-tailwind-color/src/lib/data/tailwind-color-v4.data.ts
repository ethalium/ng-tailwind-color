...
/**
 * A data structure representing version 4 of the Tailwind CSS color palette.
 ...
 *
 * Key Features:
 * - Represents Tailwind CSS version 4 color palette.
 ...
 * @internal
 */
export const TAILWIND_COLORS_V4: TWColorData = {
  slate: {
